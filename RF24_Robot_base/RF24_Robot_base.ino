...
void loop() {
  if(radio.available()) {
    ...
    int right_speed = (atoi(right_speed_string)/99.0)*drive_right_max;
    char left_speed_string[3] = {receive_payload[4], receive_payload[5]};
    int left_speed = (atoi(left_speed_string)/99.0)*drive_left_max;
    ...
    char sensor_string[2] = {payload_result};
    Serial.print("Right:");
